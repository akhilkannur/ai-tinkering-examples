# AI Automation & Developer Tools Master Context
> Low-code automation, local AI setup, and engineering productivity blueprints.

## 📑 Table of Contents
- [Advocacy Fatigue Saver](#advocacy-fatigue-saver)
- [The Attribution Modeler](#the-attribution-modeler)
- [Attribution Window Comparer](#attribution-window-comparer)
- [Basket Correlation Engine](#basket-correlation-engine)
- [Beta Tester Verifier](#beta-tester-verifier)
- [Advisory Board Scout](#advisory-board-scout)
- [The Efficiency Hawk](#the-efficiency-hawk)
- [High-Value Cart Recovery](#high-value-cart-recovery)
- [Case Study Expiry Audit](#case-study-expiry-audit)
- [Checkout Flow Analyzer](#checkout-flow-analyzer)
- [Heuristic Churn Predictor](#heuristic-churn-predictor)
- [Churn Reason Aggregator](#churn-reason-aggregator)
- [The Churn Survey Analyzer](#the-churn-survey-analyzer)
- [Churn Exit Video Analyzer](#churn-exit-video-analyzer)
- [Churn Risk Detector](#churn-risk-detector)
- [Churn Red Flag Report](#churn-red-flag-report)
- [Churn Autopsy](#churn-autopsy)
- [Community Champion Scorer](#community-champion-scorer)
- [Community Toxicity Monitor](#community-toxicity-monitor)
- [Cross-Sell Recommender](#cross-sell-recommender)
- [The CTA Button Optimizer](#the-cta-button-optimizer)
- [The Customer Health Score Builder](#the-customer-health-score-builder)
- [Usage-to-Health Validator](#usage-to-health-validator)
- [Segment Migration Tracker](#segment-migration-tracker)
- [The CS Handover Factory](#the-cs-handover-factory)
- [Support Sentiment Tracker](#support-sentiment-tracker)
- [Support Cost vs LTV](#support-cost-vs-ltv)
- [Coupon Leak Detector](#coupon-leak-detector)
- [Adoption Gap Hunter](#adoption-gap-hunter)
- [Feature Sunsetting Comms Planner](#feature-sunsetting-comms-planner)
- [Feature Adoption Trends](#feature-adoption-trends)
- [The Franchise Brand Guardian](#the-franchise-brand-guardian)
- [Perfect Review Timer](#perfect-review-timer)
- [The Heatmap Predictor](#the-heatmap-predictor)
- [Holiday Shopper Wake-Up](#holiday-shopper-wake-up)
- [Stalled Project Alert](#stalled-project-alert)
- [The Instagram Blueprint Auto-Poster](#the-instagram-blueprint-auto-poster)
- [The "5-Second Test" Simulator](#the--5-second-test--simulator)
- [The Landing Page Hero Auditor](#the-landing-page-hero-auditor)
- [Ad-to-Page Matcher](#ad-to-page-matcher)
- [The LP Optimizer](#the-lp-optimizer)
- [Loyalty Point Breakage Estimator](#loyalty-point-breakage-estimator)
- [Point Expiry Nudge](#point-expiry-nudge)
- [Device Conversion Gap](#device-conversion-gap)
- [Product Satisfaction Score](#product-satisfaction-score)
- [The NPS Comment Classifier](#the-nps-comment-classifier)
- [NPS Detractor Recovery List](#nps-detractor-recovery-list)
- [NPS Trend Spotter](#nps-trend-spotter)
- [Onboarding Milestone Celebrator](#onboarding-milestone-celebrator)
- [One-and-Done Profiler](#one-and-done-profiler)
- [OOS Traffic Preserver](#oos-traffic-preserver)
- [Pop-up Efficiency Tracker](#pop-up-efficiency-tracker)
- [The Pricing Auditor](#the-pricing-auditor)
- [PDP Performance Auditor](#pdp-performance-auditor)
- [Power User Identifier](#power-user-identifier)
- [QBR Data Aggregator](#qbr-data-aggregator)
- [QBR Deck Generator](#qbr-deck-generator)
- [The QBR Strategist](#the-qbr-strategist)
- [Reference ROI Calculator](#reference-roi-calculator)
- [Referral Fraud Pattern Detector](#referral-fraud-pattern-detector)
- [Referral Fraud Detector](#referral-fraud-detector)
- [Quality of Traffic Audit](#quality-of-traffic-audit)
- [The Renewal Reminder](#the-renewal-reminder)
- [The Renewal Risk Scorer](#the-renewal-risk-scorer)
- [The Save Playbook Auditor](#the-save-playbook-auditor)
- [Repurchase Rate Monitor](#repurchase-rate-monitor)
- [The Competitive Review Miner](#the-competitive-review-miner)
- [Review Request Timer](#review-request-timer)
- [The Brand Guardian](#the-brand-guardian)
- [Review Sentiment Correlation](#review-sentiment-correlation)
- [The Social Proof Pacer](#the-social-proof-pacer)
- [The Usage-Based Nudge](#the-usage-based-nudge)
- [Seat Utilization Nudge](#seat-utilization-nudge)
- [Peak Sales Timer](#peak-sales-timer)
- [Automated Screenshot Capture System](#automated-screenshot-capture-system)
- [Replenishment Timer](#replenishment-timer)
- [Speed vs Revenue Calc](#speed-vs-revenue-calc)
- [The SQL Cohort Builder](#the-sql-cohort-builder)
- [Subscription Churn Risk](#subscription-churn-risk)
- [Support Ticket Empathy Auditor](#support-ticket-empathy-auditor)
- [Ticket Volume Clusterer](#ticket-volume-clusterer)
- [Case Study Gap Finder](#case-study-gap-finder)
- [The Support Capacity Planner](#the-support-capacity-planner)
- [Time-to-Value Clock](#time-to-value-clock)
- [The Onboarding Bottleneck Finder](#the-onboarding-bottleneck-finder)
- [Trust Badge A/B Analyzer](#trust-badge-a-b-analyzer)
- [Unsub Retargeter](#unsub-retargeter)
- [The Friction Hunter Simulation](#the-friction-hunter-simulation)
- [Onboarding Leak Detector](#onboarding-leak-detector)
- [The UX Vision Auditor](#the-ux-vision-auditor)
- [Video Testimonial Scout](#video-testimonial-scout)
- [VIP Graduation Alert](#vip-graduation-alert)
- [The Growth Loop Architect](#the-growth-loop-architect)
- [The Onboarding Factory](#the-onboarding-factory)
- [Win-Back Segmenter](#win-back-segmenter)
- [Zero-Result Search Auditor](#zero-result-search-auditor)
...
**Category:** Customer Success | **Archetype:** Processor
...
**Category:** CRO | **Archetype:** Processor
...
**Category:** Retention | **Archetype:** Processor
...
**Category:** Retention | **Archetype:** undefined
...
**Category:** Customer Success | **Archetype:** undefined
...
**Category:** CRO | **Archetype:** undefined
...
**Category:** Product Ops | **Archetype:** Processor
...
**Category:** Brand | **Archetype:** processor
...
**Category:** Social Media | **Archetype:** undefined
...
## The QBR Strategist
**Category:** Customer Success | **Archetype:** Hybrid
...
**Category:** Dev Tools | **Archetype:** Processor
**Tagline:** Capture beautiful, consistent screenshots from any URL programmatically.


# What This Does
It visits a list of URLs, takes a screenshot of each, crops out the clutter (like sidebars or ads), and adds a professional "beautify" effect (shadows, gradients) to make them look like high-quality marketing assets.

# What You Need
- A list of URLs in a CSV file (e.g., `urls.csv`)
- Node.js installed on your computer
- (Optional) An API key if you want to use a cloud service, but this recipe works locally with Puppeteer.

# What You Get
- A folder full of high-quality `.jpg` or `.png` images
- Consistent framing and styling for all your screenshots
- No more manual cropping or editing in Photoshop/Canva

# How to Use
1. Prepare your `urls.csv` with the links you want to capture
2. Open Claude Code, Gemini CLI, or Cursor in a new folder
3. Copy and paste the prompt below
4. Run the generated script to get your images
...
## The Friction Hunter Simulation
**Category:** Product Ops | **Archetype:** Researcher
