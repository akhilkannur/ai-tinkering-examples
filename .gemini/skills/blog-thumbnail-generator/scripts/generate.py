...
def main():
    ...
    # Check for CLI arguments: python generate.py "My Title" filename.png
    if len(sys.argv) == 3:
        text = sys.argv[1]
        filename = sys.argv[2]
        generate_image(filename, text)
    else:
        print("No specific arguments provided. Generating default list...")
