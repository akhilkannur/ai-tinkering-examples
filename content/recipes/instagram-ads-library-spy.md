...
description: >-
  ...
  Pixel) are burning cash. This agent cross-references the FB Ad Library with a
  pixel-checker on their site to find high-intent agency leads.
sampleData:
  filename: d2c_domains.csv
  content: |
    Domain
    brand-a.com
    brand-b.com
