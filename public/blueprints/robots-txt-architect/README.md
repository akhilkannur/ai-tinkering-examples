# The Robots.txt Architect

AI bots (GPTBot, CCBot) are scraping your proprietary data. This agent designs optimized `robots.txt` files for multiple domains that allow search engines like Google/Bing but block AI scrapers to protect your IP.
