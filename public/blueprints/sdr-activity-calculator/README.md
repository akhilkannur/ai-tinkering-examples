# The SDR Activity Calculator

How many calls does it take to get a meeting? This agent calculates the specific conversion rates (Call -> Connect -> Meeting -> Opp) for your team and tells each SDR exactly how many dials they need to make daily to hit goal.
