# The Time-to-Value Tracker

Churn happens when value is slow. This agent calculates the days between 'Account Created' and 'First Key Action' (e.g., First Report Sent) for each customer, flagging onboarding bottlenecks.
