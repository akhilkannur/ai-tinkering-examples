# The TikTok Hook Generator

Writer's block? This agent takes a topic and generates 10 'Viral Framework' hooks (e.g., 'Stop doing X', 'I tried Y so you don't have to', 'The secret to Z') tailored to your specific subject.
