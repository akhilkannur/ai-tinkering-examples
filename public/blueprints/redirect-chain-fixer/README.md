# The Redirect Chain Fixer

A -> B -> C is bad for speed and SEO. This agent takes a list of redirect hops and 'flattens' them, generating a CSV where every source points directly to the final destination (A -> C).
