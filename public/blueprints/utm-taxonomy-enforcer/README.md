# The UTM Taxonomy Guard

Inconsistent UTMs (e.g., 'fb' vs 'Facebook') break your analytics. This agent reads a list of 1000+ URLs from a CSV and validates them against your strict brand naming conventions, flagging every violation for a fix.
