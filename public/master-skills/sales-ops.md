# Sales Operations & Lead Gen Master Context
> The complete intelligence for building automated outbound systems, lead enrichment, and CRM management.

## 📑 Table of Contents
- [The 10-K Stitcher](#the-10-k-stitcher)
- [The Abandoned Cart SMS Writer](#the-abandoned-cart-sms-writer)
- [ABM Account Tiering Calc](#abm-account-tiering-calc)
- [Corporate Hierarchy Builder](#corporate-hierarchy-builder)
- [Activation Rate by Cohort](#activation-rate-by-cohort)
- [The Alumni Network Miner](#the-alumni-network-miner)
- [The Angel Portfolio Scanner](#the-angel-portfolio-scanner)
- [The 10-K Strategic Hunter](#the-10-k-strategic-hunter)
- [The API Fleet Monitor](#the-api-fleet-monitor)
- [The API Usage Biller](#the-api-usage-biller)
- [The Sales Sniper](#the-sales-sniper)
- [The Ecosystem Partner Finder](#the-ecosystem-partner-finder)
- [The Competitor Poacher](#the-competitor-poacher)
- [Content Usage Tracker](#content-usage-tracker)
- [Billing Contact Verifier](#billing-contact-verifier)
- [Annual Pre-Pay Upsell](#annual-pre-pay-upsell)
- [The Board Room Infiltrator](#the-board-room-infiltrator)
- [The Boolean Search Architect](#the-boolean-search-architect)
- [The Tech Displacement Factory](#the-tech-displacement-factory)
- [The Business Card Digitizer](#the-business-card-digitizer)
- [Buying Committee Auditor](#buying-committee-auditor)
- [Account Buying Signal Heatmapper](#account-buying-signal-heatmapper)
- [Call Sentiment Optimizer](#call-sentiment-optimizer)
- [The Hiring Intent Trigger](#the-hiring-intent-trigger)
- [The Case Study Factory](#the-case-study-factory)
- [The Podcast Tour Stalker](#the-podcast-tour-stalker)
- [The Challenger Brand Hunter](#the-challenger-brand-hunter)
- [Champion Job Change Tracker](#champion-job-change-tracker)
- [The Champion Verifier](#the-champion-verifier)
- [Churn Cohort Analyzer](#churn-cohort-analyzer)
- [The Churn Sentinel](#the-churn-sentinel)
- [The Trend-Based Churn Predictor](#the-trend-based-churn-predictor)
- [Commission Clawback Audit](#commission-clawback-audit)
- [The Cloud Bill Shock Hunter](#the-cloud-bill-shock-hunter)
- [Cold Call Simulator (The Grumpy Prospect)](#cold-call-simulator--the-grumpy-prospect-)
- [The Cold DM Personalizer](#the-cold-dm-personalizer)
- [Cold Email Personalizer](#cold-email-personalizer)
- [The Spam Word Hunter](#the-spam-word-hunter)
- [The Sales Comp Designer](#the-sales-comp-designer)
- [Clawback Risk Monitor](#clawback-risk-monitor)
- [The Comp Plan Simulator](#the-comp-plan-simulator)
- [Commission Variance Alert](#commission-variance-alert)
- [Conference Networking Strategist](#conference-networking-strategist)
- [The Conference Batch Scraper](#the-conference-batch-scraper)
- [The Sponsor List Enricher](#the-sponsor-list-enricher)
- [The Channel Partner Scout](#the-channel-partner-scout)
- [Enrichment Freshness Audit](#enrichment-freshness-audit)
- [Account Stakeholder Density](#account-stakeholder-density)
- [The Ghost Blog Hunter](#the-ghost-blog-hunter)
- [Auto-Renew Forecaster](#auto-renew-forecaster)
- [The Legal Risk Scanner](#the-legal-risk-scanner)
- [Revenue Cliff Visualizer](#revenue-cliff-visualizer)
- [Legal Redline Risk Spotter](#legal-redline-risk-spotter)
- [The Renewal Negotiator](#the-renewal-negotiator)
- [Renewal Radar](#renewal-radar)
- [Pre-Renewal Health Check](#pre-renewal-health-check)
- [High-Value Dunning Prioritizer](#high-value-dunning-prioritizer)
- [CRM Hygiene Scorecard](#crm-hygiene-scorecard)
- [CRM Field Health Check](#crm-field-health-check)
- [Product Penetration Matrix](#product-penetration-matrix)
- [Cross-Sell Whitespace Matrix](#cross-sell-whitespace-matrix)
- [The Open Source Stalker](#the-open-source-stalker)
- [Global Pipeline Normalizer](#global-pipeline-normalizer)
- [Domain from Email Extractor](#domain-from-email-extractor)
- [The Support Scaler](#the-support-scaler)
- [Discount Guardrails Bot](#discount-guardrails-bot)
- [Deal Push Diagnostics](#deal-push-diagnostics)
- [Deal Rotting Monitor](#deal-rotting-monitor)
- [The Deal Slippage Healer](#the-deal-slippage-healer)
- [The Champion Tracker](#the-champion-tracker)
- [The Demo Playbook Factory](#the-demo-playbook-factory)
- [Stage Conversion Auditor](#stage-conversion-auditor)
- [No-Show Rate Analyzer](#no-show-rate-analyzer)
- [Demo-to-Trial Converter](#demo-to-trial-converter)
- [Deal Desk SLA Monitor](#deal-desk-sla-monitor)
- [Discount vs LTV Auditor](#discount-vs-ltv-auditor)
- [Regional Discount Auditor](#regional-discount-auditor)
- [Discount Efficiency Auditor](#discount-efficiency-auditor)
- [The Sales Coach](#the-sales-coach)
- [The DEI Initiative Spotter](#the-dei-initiative-spotter)
- [The New Domain Watcher](#the-new-domain-watcher)
- [Drive-Time Territory Balancer](#drive-time-territory-balancer)
- [Account Dupe Smasher](#account-dupe-smasher)
- [The Duplicate Lead Merger](#the-duplicate-lead-merger)
- [The Re-Platform Scout](#the-re-platform-scout)
- [The Product Hunt Poacher](#the-product-hunt-poacher)
- [The Email Permutator](#the-email-permutator)
- [The Hyper-Growth Radar](#the-hyper-growth-radar)
- [The Data Health Auditor](#the-data-health-auditor)
- [The Multi-Event Networking Planner](#the-multi-event-networking-planner)
- [The Alumni Boomerang](#the-alumni-boomerang)
- [Executive Network Mapper](#executive-network-mapper)
- [Upsell Propensity Scorer](#upsell-propensity-scorer)
- [The Family Office Hunter](#the-family-office-hunter)
- [Paywall Hit Detector](#paywall-hit-detector)
- [Forecast vs Actuals Tracker](#forecast-vs-actuals-tracker)
- [Forecast Integrity Auditor](#forecast-integrity-auditor)
- [The Franchise Empire Mapper](#the-franchise-empire-mapper)
- [PQL Usage Trigger](#pql-usage-trigger)
- [The Outsourcing Arbitrage](#the-outsourcing-arbitrage)
- [The Funnel Visualizer](#the-funnel-visualizer)
- [The Compliance Cop](#the-compliance-cop)
- [The Ghost Asset Hunter](#the-ghost-asset-hunter)
- [The Ghost Job Engine](#the-ghost-job-engine)
- [The Code Headhunter](#the-code-headhunter)
- [The Local Review Rescuer](#the-local-review-rescuer)
- [The GovCon Winner](#the-govcon-winner)
- [Legacy Pricing Audit](#legacy-pricing-audit)
- [The Headless Tech Hunter](#the-headless-tech-hunter)
- [The Freeze Thaw Detector](#the-freeze-thaw-detector)
- [ICP Scorer (Lead Grading)](#icp-scorer--lead-grading-)
- [CRM Hygiene: The Reaper](#crm-hygiene--the-reaper)
- [Win Rate by Origin](#win-rate-by-origin)
- [The Inc. 5000 Debutante](#the-inc--5000-debutante)
- [Industry Taxonomy Enforcer](#industry-taxonomy-enforcer)
- [Influencer Brand Safety Scanner](#influencer-brand-safety-scanner)
- [The Ad-Pixel Arbitrage](#the-ad-pixel-arbitrage)
- [Investor Update Writer](#investor-update-writer)
- [The Pre-IPO Hawk](#the-pre-ipo-hawk)
- [The Sales Job Description Optimizer](#the-sales-job-description-optimizer)
- [Account Activity Sync](#account-activity-sync)
- [Bad Payer List](#bad-payer-list)
- [The Lead Aging Alert System](#the-lead-aging-alert-system)
- [Enrichment Match Rate Auditor](#enrichment-match-rate-auditor)
- [The Lead List Cleaner](#the-lead-list-cleaner)
- [The Lead Magnet Factory](#the-lead-magnet-factory)
- [Speed-to-Lead Auditor](#speed-to-lead-auditor)
- [Routing Rule Validator](#routing-rule-validator)
- [Routing Conflict Detector](#routing-conflict-detector)
- [The Lead Routing Validator](#the-lead-routing-validator)
- [Lead Score Decay Calc](#lead-score-decay-calc)
- [The Lead Scorer](#the-lead-scorer)
- [Lead Source Normalizer](#lead-source-normalizer)
- [Lead-to-Account Matcher](#lead-to-account-matcher)
- [LinkedIn Account Targeting Builder](#linkedin-account-targeting-builder)
- [Non-Cringe LinkedIn Connector](#non-cringe-linkedin-connector)
- [The Niche Group Miner](#the-niche-group-miner)
- [LinkedIn Voice DM Scripter](#linkedin-voice-dm-scripter)
- [The Local Market Factory](#the-local-market-factory)
- [The Golden Lead Cloner](#the-golden-lead-cloner)
- [The Lost Deal Reviver](#the-lost-deal-reviver)
- [The M&A Chaos Hunter](#the-m-a-chaos-hunter)
- [The Portfolio Reverse Engineer](#the-portfolio-reverse-engineer)
- [Rep Focus Time Tracker](#rep-focus-time-tracker)
- [The No-Show Detective](#the-no-show-detective)
- [No-Show Correlation Engine](#no-show-correlation-engine)
- [The Calendar Defender](#the-calendar-defender)
- [Meeting-to-Opp Converter](#meeting-to-opp-converter)
- [The SDK Sniper](#the-sdk-sniper)
- [MQL Follow-up Velocity](#mql-follow-up-velocity)
- [Single-Thread Risk Detector](#single-thread-risk-detector)
- [The Newsletter Sponsor Finder](#the-newsletter-sponsor-finder)
- [The Grant Money Hunter](#the-grant-money-hunter)
- [The Objection Crusher](#the-objection-crusher)
- [Objection Gap Analyzer](#objection-gap-analyzer)
- [Onboarding Drop-off Audit](#onboarding-drop-off-audit)
- [Ownership Mismatch Finder](#ownership-mismatch-finder)
- [Stage Aging Histogram](#stage-aging-histogram)
- [Orphaned Contact Re-Homer](#orphaned-contact-re-homer)
- [Outreach Cadence Tuner](#outreach-cadence-tuner)
- [Partner Account Overlap Mapper](#partner-account-overlap-mapper)
- [The R&D Spy](#the-r-d-spy)
- [The PE Rollup Hunter](#the-pe-rollup-hunter)
- [Global Phone Formatter](#global-phone-formatter)
- [Pipeline Coverage Monitor](#pipeline-coverage-monitor)
- [The Pipeline Hygiene Scorer](#the-pipeline-hygiene-scorer)
- [Deal Push Frequency Tracker](#deal-push-frequency-tracker)
- [Pipeline Bottleneck Finder](#pipeline-bottleneck-finder)
- [Product Stagnation Analyzer](#product-stagnation-analyzer)
- [Slow Deal Accelerator](#slow-deal-accelerator)
- [The Pipeline Velocity Tracker](#the-pipeline-velocity-tracker)
- [The Podcast Ad Spender](#the-podcast-ad-spender)
- [The Pre-Meeting Dossier](#the-pre-meeting-dossier)
- [The Partnership Announcement Alert](#the-partnership-announcement-alert)
- [Price Integrity Auditor](#price-integrity-auditor)
- [The Pricing Tier Migrator](#the-pricing-tier-migrator)
- [Sales Email Tone Mirror](#sales-email-tone-mirror)
- [The Psychological Buyer Profiler](#the-psychological-buyer-profiler)
- [The Quiz Funnel Builder](#the-quiz-funnel-builder)
- [Sales Performance Distro](#sales-performance-distro)
- [The Quota Forecaster](#the-quota-forecaster)
- [Product SKU Integrity Checker](#product-sku-integrity-checker)
- [Quote-to-Cash Speedometer](#quote-to-cash-speedometer)
- [The Deal Friction Hunter](#the-deal-friction-hunter)
- [Ramp Time Cohort Analyst](#ramp-time-cohort-analyst)
- [The Reddit Signal Scout](#the-reddit-signal-scout)
- [Sales Reference Rotator](#sales-reference-rotator)
- [Referral Request Writer](#referral-request-writer)
- [The Remote First Hunter](#the-remote-first-hunter)
- [Renewal Price Lift Calc](#renewal-price-lift-calc)
- [Renewal Ghosting Detector](#renewal-ghosting-detector)
- [Revenue Leakage Audit](#revenue-leakage-audit)
- [The RFP Responder](#the-rfp-responder)
- [The SaaS Metric Dashboarder](#the-saas-metric-dashboarder)
- [The Price Hike Monitor](#the-price-hike-monitor)
- [Zombie Account Hunter](#zombie-account-hunter)
- [Activity-to-Revenue Efficiency](#activity-to-revenue-efficiency)
- [Rep Activity Scorecard](#rep-activity-scorecard)
- [The Sales Battlecard Builder](#the-sales-battlecard-builder)
- [Sales Script Compliance](#sales-script-compliance)
- [Sales Call Objection Heatmapper](#sales-call-objection-heatmapper)
- [The Call Sentiment Tracker](#the-call-sentiment-tracker)
- [Talk/Listen Ratio Auditor](#talk-listen-ratio-auditor)
- [BANT Transcript Analyzer](#bant-transcript-analyzer)
- [Sales Cycle Anomaly Hunter](#sales-cycle-anomaly-hunter)
- [Discovery Call Scripter](#discovery-call-scripter)
- [A/B Test Architect](#a-b-test-architect)
- [Ghost-Busting Follow-Up](#ghost-busting-follow-up)
- [Forecast Scenario Modeler](#forecast-scenario-modeler)
- [Pipeline Leak Detector](#pipeline-leak-detector)
- [The Sales Interview Architect](#the-sales-interview-architect)
- [The Closer's Script](#the-closer-s-script)
- [Competitor Battlecard Builder](#competitor-battlecard-builder)
- [Quota Scenario Planner](#quota-scenario-planner)
- [New Rep Ramp Tracker](#new-rep-ramp-tracker)
- [The Difficult Prospect Simulator](#the-difficult-prospect-simulator)
- [The VP Sales Headhunter](#the-vp-sales-headhunter)
- [Territory Fairness Balancer](#territory-fairness-balancer)
- [The Territory Mapper](#the-territory-mapper)
- [Pipeline Velocity Trend](#pipeline-velocity-trend)
- [The Quota Reverse-Engineer](#the-quota-reverse-engineer)
- [SDR Booking Efficiency](#sdr-booking-efficiency)
- [The SDR Ramp Architect](#the-sdr-ramp-architect)
- [Territory Saturation Auditor](#territory-saturation-auditor)
- [License Utilization Alert](#license-utilization-alert)
- [The Stealth Mode Breaker](#the-stealth-mode-breaker)
- [The Sleeping Giant Hunter](#the-sleeping-giant-hunter)
- [The Social Signal Engine](#the-social-signal-engine)
- [The PR Crisis Ambulance](#the-pr-crisis-ambulance)
- [The Stalled Deal Wake-Up Script](#the-stalled-deal-wake-up-script)
- [Investor Thesis Matcher](#investor-thesis-matcher)
- [State/Region Standardizer](#state-region-standardizer)
- [PQL Hunter (Product Qualified Leads)](#pql-hunter--product-qualified-leads-)
- [The Supply Chain Risk Mapper](#the-supply-chain-risk-mapper)
- [The Support Upseller](#the-support-upseller)
- [SaaS Seat Auditor](#saas-seat-auditor)
- [Bulk Territory Reassigner](#bulk-territory-reassigner)
- [The TikTok Shop Scout](#the-tiktok-shop-scout)
- [Pipeline Stage Stall Monitor](#pipeline-stage-stall-monitor)
- [Trial Closing Prioritizer](#trial-closing-prioritizer)
- [Price Increase Success Rate](#price-increase-success-rate)
- [The Upsell Architect](#the-upsell-architect)
- [Vertical Market Penetration](#vertical-market-penetration)
- [The Viral Loop Doctor](#the-viral-loop-doctor)
- [Voice Agent Script Improver](#voice-agent-script-improver)
- [Cold Call Voicemail A/B Tester](#cold-call-voicemail-a-b-tester)
- [The Webinar Sequence Factory](#the-webinar-sequence-factory)
- [The Event ROI Analyst](#the-event-roi-analyst)
- [Weighted Revenue Forecaster](#weighted-revenue-forecaster)
- [The Win/Loss Forensics Agent](#the-win-loss-forensics-agent)
- [Win/Loss Reason Analyzer](#win-loss-reason-analyzer)
- [Enterprise Consolidation Hunter](#enterprise-consolidation-hunter)
- [YouTube Comment Lead Miner](#youtube-comment-lead-miner)
- [Inactive Free User Purge](#inactive-free-user-purge)
...
## The 10-K Stitcher
**Category:** Sales Ops | **Archetype:** Researcher
...
**Category:** Sales Ops | **Archetype:** Hybrid
...
**Category:** Sales Ops | **Archetype:** undefined
...
**Category:** Sales Ops | **Archetype:** Processor
...
**Category:** Lead Gen | **Archetype:** Researcher
...
**Category:** Lead Gen | **Archetype:** Analyst
...
## The Sales Sniper
**Category:** Lead Gen | **Archetype:** Hybrid
...
**Category:** Lead Gen | **Archetype:** Processor
...
**Category:** Lead Gen | **Archetype:** undefined
...
## Role
You are an expert in **Sales Ops**. You are designed to automate the specific workflow of **Sales Email Tone Mirror**.

## Objective
Match your prospect's communication style instantly.
...
## Role
You are an expert in **Sales Ops**. You are designed to automate the specific workflow of **Sales Call Objection Heatmapper**.

## Objective
Visualize exactly when and why your deals are dying.
...
3.  **Map Optimization (Week 4):** Transition to full volume and advanced objection roleplay.
...
## Role
You are an expert in **Sales Ops**. You are designed to automate the specific workflow of **Cold Call Voicemail A/B Tester**.

## Objective
Systematically test which voicemail gets a callback.

## Workflow

### Phase 1: Context & Setup
1.  **Read Inputs:** Load the `sampleData` provided in the frontmatter.
2.  **Analyze Goal:** Understand that the user wants to achieve: Generates 3 variant scripts for voicemails: "The Mystery", "The Value Prop", "The Referral". Tracks callback rates to declare a winner.

### Phase 2: Execution Strategy
1.  **Step 1:** Ingest the data row by row.
2.  **Step 2:** Apply the specific logic for Cold Call Voicemail A/B Tester. (e.g. If using Vision, analyze the image. If using Text, parse the transcript).
3.  **Step 3:** Generate the structured output.
...
## Role
You are an expert in **Lead Gen**. You are designed to automate the specific workflow of **YouTube Comment Lead Miner**.

## Objective
Turn video comments into qualified leads.

## Workflow

### Phase 1: Context & Setup
1.  **Read Inputs:** Load the `sampleData` provided in the frontmatter.
2.  **Analyze Goal:** Understand that the user wants to achieve: Scrapes comments on your viral video. Filters for intent keywords like "Pricing?", "How do I buy?", "Is this available in...?",

### Phase 2: Execution Strategy
1.  **Step 1:** Ingest the data row by row.
2.  **Step 2:** Apply the specific logic for YouTube Comment Lead Miner. (e.g. If using Vision, analyze the image. If using Text, parse the transcript).
3.  **Step 3:** Generate the structured output.
