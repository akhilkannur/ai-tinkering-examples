# SEO & Content Engineering Master Context
> Technical SEO blueprints, content cluster automation, and programmatic SEO systems.

## 📑 Table of Contents
- [The About Page Storyteller](#the-about-page-storyteller)
- [AI Internal Linking Agent](#ai-internal-linking-agent)
- [The 'Alternative To' Hub Builder](#the--alternative-to--hub-builder)
- [The App Store Screenshot Optimizer](#the-app-store-screenshot-optimizer)
- [The Automated Video Producer](#the-automated-video-producer)
- [The AI Avatar Scriptwriter](#the-ai-avatar-scriptwriter)
- [Backlink Quality Auditor](#backlink-quality-auditor)
- [The Backlink Toxicity Checker](#the-backlink-toxicity-checker)
- [The Bio Link Architect](#the-bio-link-architect)
- [The Instant Brand Architect](#the-instant-brand-architect)
- [The Brand Voice Architect](#the-brand-voice-architect)
- [Broken Image Hunter](#broken-image-hunter)
- [The Technical SEO Doctor](#the-technical-seo-doctor)
- [Canonical Tag Consistency](#canonical-tag-consistency)
- [The Comment Section Nurturer](#the-comment-section-nurturer)
- [The Content Relevance Guard](#the-content-relevance-guard)
- [Content Decay Detector](#content-decay-detector)
- [The Portfolio Refresh Engine](#the-portfolio-refresh-engine)
- [The Viral Editor](#the-viral-editor)
- [The Indexing Strategist](#the-indexing-strategist)
- [Docs Freshness Auditor](#docs-freshness-auditor)
- [Changelog GIF Concept Maker](#changelog-gif-concept-maker)
- [The AI Overview Sniper](#the-ai-overview-sniper)
- [G-Maps Photo Quality Auditor](#g-maps-photo-quality-auditor)
- [GSC Index Coverage Auditor](#gsc-index-coverage-auditor)
- [The Bulk HARO Pitcher](#the-bulk-haro-pitcher)
- [Historical Content Updater](#historical-content-updater)
- [The Hreflang Builder](#the-hreflang-builder)
- [Accessibility Auditor](#accessibility-auditor)
- [The Bulk Alt Text Writer](#the-bulk-alt-text-writer)
- [The IndexNow Auto-Submitter](#the-indexnow-auto-submitter)
- [The Infinite Repurposer Chain](#the-infinite-repurposer-chain)
- [The Caption Formatting Factory](#the-caption-formatting-factory)
- [Anchor Text Optimizer](#anchor-text-optimizer)
- [The Sitemap Scanner](#the-sitemap-scanner)
- [The Link Graph Architect](#the-link-graph-architect)
- [The SERP Conflict Resolver](#the-serp-conflict-resolver)
- [The Semantic Cluster Hunter](#the-semantic-cluster-hunter)
- [SERP Volatility Tracker](#serp-volatility-tracker)
- [The Link Gap Detective](#the-link-gap-detective)
- [Link-in-Bio Broken Link Checker](#link-in-bio-broken-link-checker)
- [The Audio Event Planner](#the-audio-event-planner)
- [The Carousel Architect](#the-carousel-architect)
- [The Connection Request Writer](#the-connection-request-writer)
- [The LinkedIn Newsletter Launcher](#the-linkedin-newsletter-launcher)
- [The LinkedIn Banner Architect](#the-linkedin-banner-architect)
- [LinkedIn Visual Hook Scorer](#linkedin-visual-hook-scorer)
- [LLMS.txt Generator for AI Agents](#llms-txt-generator-for-ai-agents)
- [The Multi-Location SEO Auditor](#the-multi-location-seo-auditor)
- [The Log File Analyzer](#the-log-file-analyzer)
- [The Brand Scientist](#the-brand-scientist)
- [The Multi-Niche News Curator](#the-multi-niche-news-curator)
- [The News Jacker](#the-news-jacker)
- [Newsletter Vibe Check](#newsletter-vibe-check)
- [The Next.js Codebase Auditor](#the-next-js-codebase-auditor)
- [Speed Budget Enforcer](#speed-budget-enforcer)
- [The PAA Scraper](#the-paa-scraper)
- [The Viral Clip Factory](#the-viral-clip-factory)
- [Podcast Guest Matchmaker](#podcast-guest-matchmaker)
- [The Podcast Guest Pitcher](#the-podcast-guest-pitcher)
- [The Chapter & Timestamp Architect](#the-chapter---timestamp-architect)
- [The Conversational Ad Read Factory](#the-conversational-ad-read-factory)
- [The Podcast Tour Manager](#the-podcast-tour-manager)
- [The Poll Strategy Generator](#the-poll-strategy-generator)
- [The P-SEO Research Enricher](#the-p-seo-research-enricher)
- [Redirect Chain Flattener](#redirect-chain-flattener)
- [The Migration Doctor](#the-migration-doctor)
- [Migration Redirect Checker](#migration-redirect-checker)
- [robots.txt Rules Architect](#robots-txt-rules-architect)
- [Bulk Schema JSON-LD Generator](#bulk-schema-json-ld-generator)
- [Search Intent Miner](#search-intent-miner)
- [The Keyword Clusterer](#the-keyword-clusterer)
- [The SEO Cluster Architect](#the-seo-cluster-architect)
- [The SEO Interlinker](#the-seo-interlinker)
- [SEO Cannibalization Visualizer](#seo-cannibalization-visualizer)
- [The SEO Title Factory](#the-seo-title-factory)
- [The SERP Intent Decoder](#the-serp-intent-decoder)
- [The Short-Form Script Factory](#the-short-form-script-factory)
- [High-Coverage Sitemap Generator](#high-coverage-sitemap-generator)
- [Sitemap Health Auditor](#sitemap-health-auditor)
- [Orphan Page Detective](#orphan-page-detective)
- [The Content Inventory Builder](#the-content-inventory-builder)
- [Engagement Truth Teller](#engagement-truth-teller)
- [Broken Link Patroller](#broken-link-patroller)
- [The Subdomain vs. Subfolder Decider](#the-subdomain-vs--subfolder-decider)
- [The AI Search Doctor](#the-ai-search-doctor)
- [The Terminal Streamer](#the-terminal-streamer)
- [TikTok Audio Trend Matcher](#tiktok-audio-trend-matcher)
- [The Viral Scripter](#the-viral-scripter)
- [The Trend Adapter](#the-trend-adapter)
- [Topic Cluster Architect](#topic-cluster-architect)
- [The Trend Hunter](#the-trend-hunter)
- [The Trend Surfer](#the-trend-surfer)
- [Twitter Space Scribe](#twitter-space-scribe)
- [The Twitter Thread Architect](#the-twitter-thread-architect)
- [UGC Ad Potential Scorer](#ugc-ad-potential-scorer)
- [The Unicorn Content Curator](#the-unicorn-content-curator)
- [The UGC Campaign Planner](#the-ugc-campaign-planner)
- [The Visual Storyteller](#the-visual-storyteller)
- [The Webinar Deck Builder](#the-webinar-deck-builder)
- [The Chapter Maker](#the-chapter-maker)
- [The Community Tab Poster](#the-community-tab-poster)
- [The Video Distiller](#the-video-distiller)
- [The Thumbnail Strategy Factory](#the-thumbnail-strategy-factory)
- [The Zero-Click Optimizer](#the-zero-click-optimizer)
- [The Zero-Volume Hunter](#the-zero-volume-hunter)
...
**Category:** Content Ops | **Archetype:** Hybrid
...
**Category:** SEO | **Archetype:** undefined
...
**Category:** Content Ops | **Archetype:** Processor
...
**Category:** SEO | **Archetype:** Processor
...
**Category:** Content Ops | **Archetype:** undefined
...
**Category:** Content Ops | **Archetype:** Researcher
...
**Category:** SEO | **Archetype:** Researcher
...
## Role
You are an expert in **Content Ops**. You are designed to automate the specific workflow of **Link-in-Bio Broken Link Checker**.

## Objective
Ensure your most valuable link actually works.
...
**Category:** SEO Ops | **Archetype:** Processor
