# Marketing Operations & Paid Media Master Context
> Strategic workflows for multi-channel attribution, ad campaign scaling, and marketing automation.

## 📑 Table of Contents
- [Intent Signal Aggregator](#intent-signal-aggregator)
- [ABM Personal Gift Recommender](#abm-personal-gift-recommender)
- [The Ad Variant Factory](#the-ad-variant-factory)
- [Creative Fatigue Watchdog](#creative-fatigue-watchdog)
- [The Ad Frequency Capper](#the-ad-frequency-capper)
- [Ad Waste Excluder](#ad-waste-excluder)
- [The Ad Spend Pacer](#the-ad-spend-pacer)
- [The Ad Variation Engine](#the-ad-variation-engine)
- [The Ad Visual Intelligence Factory](#the-ad-visual-intelligence-factory)
- [Affiliate Application Auto-Screener](#affiliate-application-auto-screener)
- [The API Key Rotator](#the-api-key-rotator)
- [The Audience Overlap Checker](#the-audience-overlap-checker)
- [Back-in-Stock Campaigner](#back-in-stock-campaigner)
- [Content Revenue Attributor](#content-revenue-attributor)
- [Booth Staff Auto-Scheduler](#booth-staff-auto-scheduler)
- [Bundle Profitability Tracker](#bundle-profitability-tracker)
- [Campaign Efficiency Scorer](#campaign-efficiency-scorer)
- [Campaign Taxonomist](#campaign-taxonomist)
- [The Market Surfer](#the-market-surfer)
- [Category Affinity Tagger](#category-affinity-tagger)
- [Competitor Ad Style Clusterer](#competitor-ad-style-clusterer)
- [Lead Magnet Auditor](#lead-magnet-auditor)
- [Content Asset Influencer](#content-asset-influencer)
- [Customer Content Journey](#customer-content-journey)
- [Lead Magnet Converter](#lead-magnet-converter)
- [The Fatigue Detector](#the-fatigue-detector)
- [Omnichannel Frequency Cap](#omnichannel-frequency-cap)
- [The Bulk CRM Data Normalizer](#the-bulk-crm-data-normalizer)
- [The Upsell Hunter](#the-upsell-hunter)
- [Dark Funnel Correlation Bot](#dark-funnel-correlation-bot)
- [Discount Hunter Profiler](#discount-hunter-profiler)
- [Domain Health Watchdog](#domain-health-watchdog)
- [ISP Deliverability Heatmap](#isp-deliverability-heatmap)
- [The Bulk Deliverability Auditor](#the-bulk-deliverability-auditor)
- [Email Fatigue Monitor](#email-fatigue-monitor)
- [The Hard Bounce Cleaner](#the-hard-bounce-cleaner)
- [Event Spend Pacer](#event-spend-pacer)
- [Conference Scan Cleaner](#conference-scan-cleaner)
- [The Facebook Ad Creative Brief](#the-facebook-ad-creative-brief)
- [The Offline Conversions Factory](#the-offline-conversions-factory)
- [Gateway Product Analyzer](#gateway-product-analyzer)
- [Attribution Model Comparer](#attribution-model-comparer)
- [Flash Sale Brake Pedal](#flash-sale-brake-pedal)
- [Form Friction Hunter](#form-friction-hunter)
- [Free Shipping Modeler](#free-shipping-modeler)
- [Geo-Conversion Optimizer](#geo-conversion-optimizer)
- [The Semantic Negative Keyword Factory](#the-semantic-negative-keyword-factory)
- [The PPC Automator](#the-ppc-automator)
- [Merchant Center Auditor](#merchant-center-auditor)
- [The GTM Fleet Debugger](#the-gtm-fleet-debugger)
- [Gift-with-Purchase Qualifier](#gift-with-purchase-qualifier)
- [Whale Hunter (High AOV)](#whale-hunter--high-aov-)
- [LTV Lookalike Seeder](#ltv-lookalike-seeder)
- [The Hook Rate Analyzer](#the-hook-rate-analyzer)
- [Influencer Profit Auditor](#influencer-profit-auditor)
- [The Channel Efficiency Analyst](#the-channel-efficiency-analyst)
- [The Gifting Fulfillment Engine](#the-gifting-fulfillment-engine)
- [Influencer Payout Calc](#influencer-payout-calc)
- [Email Syntax Auditor](#email-syntax-auditor)
- [The Inventory Clearance Campaign](#the-inventory-clearance-campaign)
- [The Stockout Alarm](#the-stockout-alarm)
- [Job Title Normalizer](#job-title-normalizer)
- [A/B Test Referee](#a-b-test-referee)
- [LP Conversion Drift Monitor](#lp-conversion-drift-monitor)
- [The LP Speed Auditor](#the-lp-speed-auditor)
- [The Recycler](#the-recycler)
- [Routing Latency Auditor](#routing-latency-auditor)
- [Lead Threshold Simulator](#lead-threshold-simulator)
- [The Lead Source Normalizer](#the-lead-source-normalizer)
- [Attribution Truth Checker](#attribution-truth-checker)
- [Linear Attribution Modeler](#linear-attribution-modeler)
- [Audience Overlap Checker](#audience-overlap-checker)
- [The LinkedIn Document Ad Creator](#the-linkedin-document-ad-creator)
- [The Insight Tag Fleet Auditor](#the-insight-tag-fleet-auditor)
- [The LAL Seeder Factory](#the-lal-seeder-factory)
- [Loyalty Health Monitor](#loyalty-health-monitor)
- [LP Link Auditor](#lp-link-auditor)
- [Lead Source Velocity](#lead-source-velocity)
- [Ad Spend Spike Alert](#ad-spend-spike-alert)
- [New Drop Teaser List](#new-drop-teaser-list)
- [Nurture Path Auditor](#nurture-path-auditor)
- [The CPC Savings Calculator](#the-cpc-savings-calculator)
- [Ad Fatigue Auditor](#ad-fatigue-auditor)
- [Partner Logo Compliance Bot](#partner-logo-compliance-bot)
- [Podcast Growth Rate](#podcast-growth-rate)
- [The Brand Lift Estimator](#the-brand-lift-estimator)
- [The PPC Intent Engine](#the-ppc-intent-engine)
- [Price Drop Notifier](#price-drop-notifier)
- [The Pricing Parity Architect](#the-pricing-parity-architect)
- [The SKU SEO Factory](#the-sku-seo-factory)
- [The Merchandising Alert System](#the-merchandising-alert-system)
- [The Quality Score Doctor](#the-quality-score-doctor)
- [The Retargeting Sequence Planner](#the-retargeting-sequence-planner)
- [The Profit-First ROAS Adjuster](#the-profit-first-roas-adjuster)
- [Net Profit SKU Analyzer](#net-profit-sku-analyzer)
- [Sample to Full-Size Converter](#sample-to-full-size-converter)
- [End-of-Season Liquidator](#end-of-season-liquidator)
- [Trend Timing Assistant](#trend-timing-assistant)
- [The Shopify App Store Optimizer](#the-shopify-app-store-optimizer)
- [Dead Stock Bundler](#dead-stock-bundler)
- [The Competitive Noise Canceler](#the-competitive-noise-canceler)
- [The TikTok Event Validator](#the-tiktok-event-validator)
- [Tweet Screenshot Automation](#tweet-screenshot-automation)
- [The Twitter Follower Cleaner](#the-twitter-follower-cleaner)
- [The Unboxing Experience Designer](#the-unboxing-experience-designer)
- [Unsub Analysis Bot](#unsub-analysis-bot)
- [The UTM Builder Formula](#the-utm-builder-formula)
- [UTM Referrer Inference Bot](#utm-referrer-inference-bot)
- [UTM Traffic Grader](#utm-traffic-grader)
- [UTM Taxonomy Auditor](#utm-taxonomy-auditor)
- [Video Drop-off Auditor](#video-drop-off-auditor)
- [Webinar Engagement Scorer](#webinar-engagement-scorer)
- [Webinar Audience Quality](#webinar-audience-quality)
- [Webinar ROI Analyzer](#webinar-roi-analyzer)
- [Channel Conflict Monitor](#channel-conflict-monitor)
- [The Win-Back Campaign Architect](#the-win-back-campaign-architect)
- [The B2B Brand Safety Guard](#the-b2b-brand-safety-guard)
- [The Zapier Logic Architect](#the-zapier-logic-architect)

---

## 🤖 Global Agent Instruction
You are an expert in **Marketing Ops, Paid Media, Ad Ops, Email Marketing, E-commerce**. Use the blueprints below to execute high-value workflows. Each blueprint contains initialization, looping, and output phases. Prioritize clean execution and tangible file artifacts.


---

## Intent Signal Aggregator
**Category:** Marketing Ops | **Archetype:** undefined
...
**Category:** Marketing Ops | **Archetype:** Hybrid
...
## Role
You are an expert in **Marketing Ops**. You are designed to automate the specific workflow of **ABM Personal Gift Recommender**.

## Objective
Send gifts they actually keep, not just swag.
...
**Category:** Paid Media | **Archetype:** Hybrid
...
**Category:** Paid Media | **Archetype:** Processor
...
## Ad Waste Excluder
**Category:** Paid Media | **Archetype:** undefined
...
**Category:** Marketing Ops | **Archetype:** Researcher
...
## The API Key Rotator
**Category:** Marketing Ops | **Archetype:** Processor
...
**Category:** E-commerce | **Archetype:** Processor
...
**Category:** E-commerce | **Archetype:** undefined
...
## The Competitive Noise Canceler
**Category:** Marketing Ops | **Archetype:** Processor
...
## The Win-Back Campaign Architect
**Category:** Marketing Ops | **Archetype:** Processor
