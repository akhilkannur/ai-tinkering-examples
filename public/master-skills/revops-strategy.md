# RevOps & Strategic Growth Master Context
> Data-driven growth strategies, executive reporting, and market intelligence automation.

## 📑 Table of Contents
- [ABM Campaign Asset Builder](#abm-campaign-asset-builder)
- [Ad Copy Pivot Detector](#ad-copy-pivot-detector)
- [The Conquest Campaigner](#the-conquest-campaigner)
- [The Ad Library Archivist](#the-ad-library-archivist)
- [The Affiliate Program Launcher](#the-affiliate-program-launcher)
- [The Project Architect](#the-project-architect)
- [The AI Manager's Handbook](#the-ai-manager-s-handbook)
- [API Error Impact Alerter](#api-error-impact-alerter)
- [Automated SWOT Generator](#automated-swot-generator)
- [Webinar Follow-Up Architect](#webinar-follow-up-architect)
- [The Autonomous Project Manager](#the-autonomous-project-manager)
- [The Beta Tester Recruiter](#the-beta-tester-recruiter)
- [The Blueprint Architect](#the-blueprint-architect)
- [The Event Booth Strategist](#the-event-booth-strategist)
- [Event Lead Router](#event-lead-router)
- [Brand Voice Chameleon](#brand-voice-chameleon)
- [The Cancellation Flow Auditor](#the-cancellation-flow-auditor)
- [Case Study Interviewer](#case-study-interviewer)
- [The Case Study Decoder](#the-case-study-decoder)
- [The Changelog Marketer](#the-changelog-marketer)
- [Channel Conflict Resolver](#channel-conflict-resolver)
- [Deal Reg Conflict Finder](#deal-reg-conflict-finder)
- [The Onboarding Velocity Scanner](#the-onboarding-velocity-scanner)
- [Competitor Dissatisfaction Miner](#competitor-dissatisfaction-miner)
- [Ad Library Decoder](#ad-library-decoder)
- [Competitor Site Change Detector](#competitor-site-change-detector)
- [Competitor Content Spy](#competitor-content-spy)
- [Competitor Brain Drain](#competitor-brain-drain)
- [The Feature Gap Detective](#the-feature-gap-detective)
- [The Market Hiring Spy](#the-market-hiring-spy)
- [The Competitor Hook Decoder](#the-competitor-hook-decoder)
- [Feature Parity Matrix](#feature-parity-matrix)
- [Competitor Radar](#competitor-radar)
- [The Onboarding Teardown Factory](#the-onboarding-teardown-factory)
- [The Price Watchdog Fleet](#the-price-watchdog-fleet)
- [Competitor Pricing Watchdog](#competitor-pricing-watchdog)
- [Price War Monitor](#price-war-monitor)
- [Competitor Discount Tracker](#competitor-discount-tracker)
- [The Competitor UI/UX Decoder](#the-competitor-ui-ux-decoder)
- [The Market Spy](#the-market-spy)
- [The Tech Stack Spy](#the-tech-stack-spy)
- [Visual Pricing Page Monitor](#visual-pricing-page-monitor)
- [Competitor Event Monitor](#competitor-event-monitor)
- [Competitor Win Rate Trend](#competitor-win-rate-trend)
- [The Contract Risk Detector](#the-contract-risk-detector)
- [Feedback Auto-Tagger](#feedback-auto-tagger)
- [The Customer Journey Factory](#the-customer-journey-factory)
- [Community Mention Alert](#community-mention-alert)
- [Deal Reg Expiry Monitor](#deal-reg-expiry-monitor)
- [The ABM Direct Mail Engine](#the-abm-direct-mail-engine)
- [The Annual Promo Strategist](#the-annual-promo-strategist)
- [Stock Rotation Auditor](#stock-rotation-auditor)
- [The Subject Line Factory](#the-subject-line-factory)
- [Social Advocacy Leaderboard](#social-advocacy-leaderboard)
- [Event Influence Calc](#event-influence-calc)
- [Event Meeting Auditor](#event-meeting-auditor)
- [The Booth ROI Predictor](#the-booth-roi-predictor)
- [The Feature Adoption Analyzer](#the-feature-adoption-analyzer)
- [The Product Marketing Engine](#the-product-marketing-engine)
- [Feature Parity Bot](#feature-parity-bot)
- [Feature Request ARR Weighting](#feature-request-arr-weighting)
- [Feedback Cluster Engine](#feedback-cluster-engine)
- [VIP Dinner Selector](#vip-dinner-selector)
- [The Capital Radar](#the-capital-radar)
- [Voice of Customer Analyzer](#voice-of-customer-analyzer)
- [The Converting Cookie Banner](#the-converting-cookie-banner)
- [The Geographic Expansion Planner](#the-geographic-expansion-planner)
- [The GMB Fleet Optimizer](#the-gmb-fleet-optimizer)
- [Local Review Responder](#local-review-responder)
- [The Help Center Forensic Agent](#the-help-center-forensic-agent)
- [The Holiday Campaign Factory](#the-holiday-campaign-factory)
- [Indirect Revenue Forecaster](#indirect-revenue-forecaster)
- [The Influencer Auditor](#the-influencer-auditor)
- [The Influencer Contract Factory](#the-influencer-contract-factory)
- [The Relationship Builder](#the-relationship-builder)
- [The Creator Economy Auditor](#the-creator-economy-auditor)
- [Influencer Compliance Check](#influencer-compliance-check)
- [The Strategic Integration Factory](#the-strategic-integration-factory)
- [Interview Answer Rubric Scorer](#interview-answer-rubric-scorer)
- [The Invoice Chaser Engine](#the-invoice-chaser-engine)
- [Lead Magnet Factory](#lead-magnet-factory)
- [The Full-Stack Link Magnet](#the-full-stack-link-magnet)
- [The LinkedIn Comment Miner](#the-linkedin-comment-miner)
- [Connection Request A/B Tester](#connection-request-a-b-tester)
- [The LinkedIn Ghostwriter](#the-linkedin-ghostwriter)
- [Viral Poll Builder](#viral-poll-builder)
- [Segment Logic Checker](#segment-logic-checker)
- [New Market Entry Simulator](#new-market-entry-simulator)
- [MDF Budget Reconciler](#mdf-budget-reconciler)
- [Meeting Action Item Enforcer](#meeting-action-item-enforcer)
- [The Narrative Builder](#the-narrative-builder)
- [The Newsjacker](#the-newsjacker)
- [The Inbox Strategy Auditor](#the-inbox-strategy-auditor)
- [List Hygiene Scrub](#list-hygiene-scrub)
- [The Sponsor Scout Engine](#the-sponsor-scout-engine)
- [The OKR Architect](#the-okr-architect)
- [The Partner Enablement Automator](#the-partner-enablement-automator)
- [Co-Marketing Lead Splitter](#co-marketing-lead-splitter)
- [The Partner Hunter Fleet](#the-partner-hunter-fleet)
- [The Partner Page Scraper](#the-partner-page-scraper)
- [Partner Engagement Audit](#partner-engagement-audit)
- [Partner Tier Auditor](#partner-tier-auditor)
- [The Strategic Partnership Architect](#the-strategic-partnership-architect)
- [The Anti-Targeting List Builder](#the-anti-targeting-list-builder)
- [The AI Persona Researcher](#the-ai-persona-researcher)
- [The VC Pitch Deck Roast](#the-vc-pitch-deck-roast)
- [The Pitch Deck Storyboard](#the-pitch-deck-storyboard)
- [Podcast Ad Script Writer](#podcast-ad-script-writer)
- [Podcast Guest Prospector](#podcast-guest-prospector)
- [The Post-Event Follow-up](#the-post-event-follow-up)
- [Event Follow-up Police](#event-follow-up-police)
- [PR Crisis Severity Scorer](#pr-crisis-severity-scorer)
- [Geo-Targeted Event Warmup](#geo-targeted-event-warmup)
- [Code-to-Press Release Architect](#code-to-press-release-architect)
- [The Pricing Historian](#the-pricing-historian)
- [The Product Hunt Launch Manager](#the-product-hunt-launch-manager)
- [LinkedIn Profile Auditor](#linkedin-profile-auditor)
- [The High-Ticket Proposal Writer](#the-high-ticket-proposal-writer)
- [The QR Code Strategist](#the-qr-code-strategist)
- [Complex Referral Splitter](#complex-referral-splitter)
- [The Referral Fraud Hunter](#the-referral-fraud-hunter)
- [The Referral Program Architect](#the-referral-program-architect)
- [MAP Pricing Auditor](#map-pricing-auditor)
- [Review Keyword Miner](#review-keyword-miner)
- [The Review Sentiment Factory](#the-review-sentiment-factory)
- [The Review-to-Ad Factory](#the-review-to-ad-factory)
- [The Roadmap Prioritizer (RICE)](#the-roadmap-prioritizer--rice-)
- [The Packaging Strategist](#the-packaging-strategist)
- [The Scope Creep Defender](#the-scope-creep-defender)
- [SEO Content Gap Mapper](#seo-content-gap-mapper)
- [Internal Link Graph Builder](#internal-link-graph-builder)
- [Bulk Meta Tag Writer](#bulk-meta-tag-writer)
- [SERP Conquest Planner](#serp-conquest-planner)
- [Slack Community Contextual Welcomer](#slack-community-contextual-welcomer)
- [Social-to-Deal Correlator](#social-to-deal-correlator)
- [The Social Authenticity Auditor](#the-social-authenticity-auditor)
- [Social Activity Mix](#social-activity-mix)
- [Alumni Champion Finder](#alumni-champion-finder)
- [Session Pipeline Attribution](#session-pipeline-attribution)
- [Standup Blocker Extractor](#standup-blocker-extractor)
- [Swag Demand Planner](#swag-demand-planner)
- [The Strategic SWOT Generator](#the-strategic-swot-generator)
- [The AI TAM Researcher](#the-ai-tam-researcher)
- [Technographic Prospector](#technographic-prospector)
- [The Testimonial Factory](#the-testimonial-factory)
- [The Traffic Source Decoder](#the-traffic-source-decoder)
- [The Auto-Plug Writer](#the-auto-plug-writer)
- [The Twitter Bio Optimizer](#the-twitter-bio-optimizer)
- [Viral Hook Analyzer](#viral-hook-analyzer)
- [The Use Case Matrix Builder](#the-use-case-matrix-builder)
- [Meetup City Selector](#meetup-city-selector)
- [The Vendor Negotiator](#the-vendor-negotiator)
- [The Video Testimonial Director](#the-video-testimonial-director)
- [Newsletter Content Curator](#newsletter-content-curator)
- [The White Label Dashboard Setup](#the-white-label-dashboard-setup)
- [White Paper Ideator](#white-paper-ideator)
- [Competitor Win/Loss Trend](#competitor-win-loss-trend)
...
**Category:** Strategic Ops | **Archetype:** Hybrid
...
**Category:** Competitive Intel | **Archetype:** Processor
...
**Category:** Competitive Intel | **Archetype:** Hybrid
...
**Category:** Strategic Ops | **Archetype:** Researcher
...
**Category:** Strategic Ops | **Archetype:** Processor
...
**Category:** Strategic Ops | **Archetype:** undefined
...
**Category:** Competitive Intel | **Archetype:** undefined
...
## Role
You are an expert in **Competitive Intel**. You are designed to automate the specific workflow of **The Competitor UI/UX Decoder**.

## Objective
Analyze competitor screenshots to steal their best design patterns.
...
## The Market Spy
**Category:** Competitive Intel | **Archetype:** Researcher
...
**Phase 1: Ideation**
1. Read `topic.txt`.
2. Brainstorm 3 Poll Angles:
    *   **The Debate:** A/B choice on a hot topic. (e.g., "Cameras ON or OFF?").
    *   **The Benchmarking:** Asking for data. (e.g., "What % of your leads are inbound?").
    *   **The Pain:** Asking what hurts most. (e.g., "Biggest blocker to shipping code?").

**Phase 2: Drafting**
For each poll:
1.  **Question:** Under 140 chars. Clear and punchy.
2.  **Options:** Max 4 options. Max 30 chars each.
3.  **The Hook:** A 1-sentence caption to go with it.
...
## Role
You are an expert in **Strategic Ops**. You are designed to automate the specific workflow of **The VC Pitch Deck Roast**.

## Objective
Simulate a ruthless VC tearing apart your slide deck.

## Workflow

### Phase 1: Context & Setup
1.  **Read Inputs:** Load the `sampleData` provided in the frontmatter.
2.  **Analyze Goal:** Understand that the user wants to achieve: Upload your pitch deck text. The agent adopts the persona of a cynical Series A investor and highlights every logic gap, weak metric, or confusing slide.

### Phase 2: Execution Strategy
1.  **Step 1:** Ingest the data row by row.
2.  **Step 2:** Apply the specific logic for The VC Pitch Deck Roast. (e.g. If using Vision, analyze the image. If using Text, parse the transcript).
3.  **Step 3:** Generate the structured output.
