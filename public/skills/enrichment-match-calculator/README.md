# The Enrichment Match Calculator

Vendors promise '80% match rates.' This agent tests a sample file returned from an enrichment provider (Clearbit/ZoomInfo), calculating the actual % of fields populated (Phone, Industry, Rev) to audit their performance.
