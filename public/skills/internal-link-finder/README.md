# The Internal Link Opportunity Finder

Orphan pages starve. This agent reads your latest blog post, identifies key topics (entities), and scans your existing site map for older posts that mention those topics but don't link yet.
