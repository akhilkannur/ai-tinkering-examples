# The LinkedIn Carousel Factory

Carousels get the highest dwell time on LinkedIn. This agent reads a list of blog URLs from a CSV, extracts the core 'Hero's Journey', and generates a 10-slide visual script for every post.
