# The Keyword Cannibalization Detective

When two pages rank for the same keyword, neither ranks well. This agent analyzes GSC data (Keyword + URL) to find terms where multiple pages share impressions, suggesting which one to canonicalize or merge.
