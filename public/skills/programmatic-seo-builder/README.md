# The Programmatic SEO Builder

Need pages for 'Best CRM for [Industry]'? This agent takes a CSV of industries and a content template (Markdown with variables), and generates ready-to-deploy MDX files for each variation.
