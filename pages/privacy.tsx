          ...
          <div className="bg-white rounded-[2rem] border border-coffee-100 p-10 md:p-16 shadow-soft">
            <div className="max-w-none space-y-10 prose prose-lg">
                <section>
                    ...
                    <p className="text-coffee-700 font-light leading-relaxed">Welcome to Real AI Examples. We respect your privacy and are committed to protecting your personal data. This policy outlines how we handle your information.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-display font-semibold text-coffee-900 uppercase">Data We Collect</h2>
                    <p className="text-coffee-700 font-light leading-relaxed">We may collect, use, and store the following types of data:</p>
                    <ul className="space-y-3">
                        <li className="text-coffee-700 font-light"><strong className="font-semibold text-coffee-900">Identity Data:</strong> Your email address, if you subscribe to our newsletter.</li>
                        <li className="text-coffee-700 font-light"><strong className="font-semibold text-coffee-900">Technical Data:</strong> Anonymized data such as IP address, browser type, and device information for analytics purposes.</li>
                        <li className="text-coffee-700 font-light"><strong className="font-semibold text-coffee-900">Usage Data:</strong> Information about how you interact with our website and the examples you view.</li>
                    </ul>
                </section>

                <section>
                    <h2 className="text-2xl font-display font-semibold text-coffee-900 uppercase">How We Use Your Data</h2>
                    <p className="text-coffee-700 font-light leading-relaxed">We use your data to provide our services, including sending newsletters, and to improve our website through anonymous usage analytics. We do not sell your personal data to third parties.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-display font-semibold text-coffee-900 uppercase">Data Security</h2>
                    <p className="text-coffee-700 font-light leading-relaxed">We have implemented appropriate security measures to prevent your personal data from being accidentally lost, used, or accessed in an unauthorized way.</p>
                </section>
