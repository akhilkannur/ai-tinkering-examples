  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Privacy Policy | Real AI Examples" key="og:title" />
        <meta property="og:description" content="Read our privacy policy to understand how we collect and protect your personal data." key="og:description" />
        <meta property="og:image" content="https://realaiexamples.com/api/og?mode=home" key="og:image" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" key="twitter:card" />
        <meta name="twitter:title" content="Privacy Policy | Real AI Examples" key="twitter:title" />
        <meta name="twitter:description" content="Read our privacy policy to understand how we collect and protect your personal data." key="twitter:description" />
