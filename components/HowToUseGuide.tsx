    ...
    <div className="w-full max-w-5xl mx-auto mb-20">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              ...
              <strong>Agentic Tools</strong> (like Claude Code or Gemini CLI) are different. They live on your computer, so they can create files, run searches, and manage your projects—just like a remote intern.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
               <div className="flex items-center gap-3 bg-gray-700/50 px-4 py-3 rounded-xl border border-gray-600">
                 ...
                 <span className="text-sm font-medium">Install an Agent</span>
               </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">1. Pick Your Tool</h3>
