      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative pt-12 pb-16 sm:pt-16 sm:pb-24 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="relative z-10 order-first md:order-first text-center md:text-left flex-1">
            ...
            <div style={{maxWidth: "100%", overflow: "hidden", height: "100px", marginBottom: "-30px"}}>
              <iframe src="https://subscribe-forms.beehiiv.com/44f8ba74-5250-4aac-9fa0-3ad651f05798" data-test-id="beehiiv-embed" width="500" height="147" frameBorder="0" scrolling="no" className="mx-auto block" style={{margin: '0', borderRadius: '0px', backgroundColor: 'transparent', maxWidth: '100%', transform: 'translateY(-15px)'}} />
            </div>
          </div>
