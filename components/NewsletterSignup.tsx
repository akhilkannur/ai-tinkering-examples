    ...
    <div id="newsletter" className="max-w-2xl mx-auto p-6 my-8 border rounded-2xl">
      ...
      {embed ? (
        ...
        <form className="mt-4 flex gap-2">
          <input aria-label="email" placeholder="your@email.com" className="flex-1 px-3 py-2 border rounded-lg" />
          <button className="px-4 py-2 rounded-lg bg-black text-white">Subscribe</button>
        </form>
      )}
    </div>
  )
